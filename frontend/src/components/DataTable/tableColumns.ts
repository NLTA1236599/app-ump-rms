...
export const TABLE_COLUMNS: TableColumnDef[] = [
  ...
  { id: 'principalEmail', label: 'Email chủ nhiệm' },
  ...
  { id: 'budgetSettled', label: 'KP quyết toán' },
  ...
  { id: 'registrationSequenceNumber', label: 'Số thứ tự' },
  ...
  { id: 'supervisorId', label: 'Chuyên viên QL' },
