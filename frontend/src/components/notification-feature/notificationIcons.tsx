...
export function BellIconSolid({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M5.25 9a6.75 6.75 0 0 1 13.5 0v3.159c0 .538.214 1.055.595 1.436L19.5 15H4.5l.655-.405A2.032 2.032 0 0 0 5.25 12.159V9Zm6.75 8.25a3 3 0 0 1-2.912-2.25h5.824A3 3 0 0 1 12 17.25Z"
      />
    </svg>
  );
}
