...
} from '../DataEntry/useSupervisorAccounts.js';
import { useAuthContext } from '../../contexts/AuthContext.js';
import { useAssignableUsers } from '../../hooks/useAssignableUsers.js';
import { useNotification } from '../../hooks/useNotification.js';
import { researchProjectService, userDirectory } from '../../services/index.js';
import {
  buildKnownUsernames,
  CommentMentionInput,
...
} from '../notification-feature/mentions/index.js';
    ...
    >
      ...
      <div className="space-y-2 border-t border-slate-100 px-4 py-3">
        ...
        >
          ...
          <ProgressStatusSelect value={project.progressStatus} onChange={onProgressStatusChange} />
        </div>
        <div
          className="flex items-center justify-between rounded-lg border border-slate-200 px-3
                      py-2"
