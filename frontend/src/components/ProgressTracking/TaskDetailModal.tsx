...
/** Spec §10 — lightweight detail surface for saved tasks */
    ...
    >
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-4 overflow-y-auto p-6">
          ...
          <div className="col-span-2 rounded-3xl bg-slate-50 p-4">
            <p className="mb-1 text-[10px] font-black uppercase tracking-widest text-slate-400">Tiến độ hạn</p>
          ...
          <div className="col-span-2">
            <p className="mb-2 text-[10px] font-black uppercase tracking-widest text-slate-400">Ghi chú</p>
            <div className="rounded-3xl bg-slate-50 p-6 text-sm italic text-slate-600">
              {task.note?.trim()
                ? task.note
                : 'Chưa có ghi chú cho công việc này.'}
            </div>
          </div>
        </div>
