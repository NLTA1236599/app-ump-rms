/** Branding copy and layout tokens — matches port 5173 (`frontend` SiteHeader). */
export const HEADER_IDENTITY_BG = '#005b8e';
export const HEADER_NAV_BG = '#0072bc';
export const HEADER_TAB_ACTIVE_TEXT = '#005b8e';
