/**
 * Test TKKT reminders against project TESSJJPJGKDMFLKVMLKSMFCL.
 * Temporarily sets midterm due = today+30 (VN), runs engine, restores original data.
 *
 * Usage: npx tsx src/scripts/testReminderTessjj.ts
 */
...
const TITLE = 'TESSJJPJGKDMFLKVMLKSMFCL';
const PROJECT_ID = '0622ed52-5faa-43f4-b9d0-87df6caf1631';
...
async function main() {
  console.log(`=== Test nhắc mail — đề tài ${TITLE} ===`);
